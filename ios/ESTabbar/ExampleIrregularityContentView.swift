...
class ExampleIrregularityBasicContentView: ExampleBouncesContentView {
    ...
    override init(frame: CGRect) {
        ...
        backdropColor = UIColor.init(red: 245/255.0, green: 245/255.0, blue: 245/255.0, alpha: 1.0)
        highlightBackdropColor = UIColor.init(red: 245/255.0, green: 245/255.0, blue: 245/255.0, alpha: 1.0)
    }
...
class ExampleIrregularityContentView: ESTabBarItemContentView {
    ...
    override init(frame: CGRect) {
        ...
        self.imageView.layer.borderColor = UIColor.init(red: 245/255.0, green: 245/255.0, blue: 245/255.0, alpha: 1.0).cgColor
        self.imageView.layer.cornerRadius = 27
        self.insets = UIEdgeInsetsMake(-26, 0, 0, 0)
